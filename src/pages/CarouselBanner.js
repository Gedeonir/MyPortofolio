    ...
    <div className='lg:px-8 px-4 relative py-12'>
      <div className='w-full bg-secondary dark:bg-dark_secondary lg:bg-opacity-0 bg-opacity-50'>
          ...
          transition={{ duration: 0.5 }} className='text-dark_primary  '>
            ...
            <p className='text-xl mt-3 text-justify leading-10'>
              Highly motivated and self-driving individual with strong knowledge in software development. 
              Skilled in various  programing languages, with ability to learn new technologies.<br/><br/>
          ...
          className='py-2 my-8 font-bold cursor-pointer duration-300 ease-in-out animate-pulse hover:bg-opacity-90  text-btn hover:dark:bg-opacity-50'>
            <Link className='flex justify-start gap-2'>Get my resume <BsArrowRight className='my-1'/></Link>
          </div>
          </motion.div>
      ...
      <motion.div
        ...
        className='py-4 flex gap-4 justify-start lg:w-32 w-full'>
          <div className='flex gap-2 justify-start'>
            <div className='cursor-pointer w-8 h-8 drop-shadow-xl shadow-xl rounded-full hover:bg-opacity-20 dark:hover:bg-opacity-50 duration-300 ease-in-out lg:mx-auto text-dark_primary  overflow-hidden p-2 bg-primary dark:bg-dark_secondary_2 bg-opacity-10'>
              <FaLinkedinIn size={15}/>
            </div>
            <span className='font-bold text-md py-1 text-dark_primary'>Linkedin</span>
          </div>
          <div className='flex gap-2 justify-start'>
            <div className='cursor-pointer w-8 h-8 drop-shadow-xl shadow-xl rounded-full hover:bg-opacity-20 dark:hover:bg-opacity-50 duration-300 ease-in-out lg:mx-auto text-dark_primary  overflow-hidden p-2 bg-primary dark:bg-dark_secondary_2 bg-opacity-10'>
              <RiGithubLine size={15}/>
            </div>
            <span className='font-bold text-md py-1 text-dark_primary'>GitHub</span>
          </div>
